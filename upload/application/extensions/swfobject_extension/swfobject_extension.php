...
class Swfobject_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'swfobject', 'ext_description' => 'swfobject.js', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'swfobject_extension', 'ext_hook' => 'before_closing_head_tag_hook');
	...
	public function index()
	{
		$result = '';
		$result .= '
		<script type="text/javascript" src="' . FWURL . 'js/swfobject/swfobject.js"></script>';
		return $result;
	}
