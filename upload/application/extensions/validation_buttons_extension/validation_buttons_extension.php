...
class Validation_buttons_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'Validation Buttons Extension', 'ext_description' => 'HTML & CSS Validation Buttons', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'validation_buttons_extension', 'ext_hook' => 'footer_3_hook');
	...
	public function index()
	{
		...
		$result .= '<p><a href="http://validator.w3.org/check?uri=referer"><img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" /></a>';
		$result .= '<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px" src="http://jigsaw.w3.org/css-validator/images/vcss" alt="Valid CSS!" /></a></p>';
