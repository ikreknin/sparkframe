...
class Admin_tags_input_create_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'Admin Tag Input Create Extension', 'ext_description' => 'Admin Tag Input Create Extension', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'admin_tags_input_create_extension', 'ext_hook' => 'admin_articles_create_before_submit_hook');
