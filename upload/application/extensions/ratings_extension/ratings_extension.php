...
class Ratings_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'Ratings Extension', 'ext_description' => '5 Star Rating Extension', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'ratings_extension', 'ext_hook' => 'before_blog_article_hook');
	...
	public function index()
	{
		...
		$result .= '	<div id="r_' . $parameter . '" class="rate_widget">
