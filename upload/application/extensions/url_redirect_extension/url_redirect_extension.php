...
class Url_redirect_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'URL Redirect Extension', 'ext_description' => 'URL Redirect Extension', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'url_redirect_extension', 'ext_hook' => 'controller_init_hook');
...
// http://www.tulks.com/latvian/text/wit-toc.php
// to (new URL)
// http://www.tulks.com/latvian
		$urlSegments = $this->registry->getURLSegments();
		if (FWURL == 'http://tulks.com/' && $urlSegments[0] == 'latvian' && $urlSegments[1] == 'text' && $urlSegments[2] == 'wit-toc.php')
		{
			header('Location: http://www.tulks.com/latvian');
		}
		return $result;
	}
