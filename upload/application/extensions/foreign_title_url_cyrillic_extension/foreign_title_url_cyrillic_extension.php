...
class Foreign_title_url_cyrillic_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'Foreign Title Url Cyrillic Extension', 'ext_description' => 'Foreign Title Url Cyrillic Extension', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'foreign_title_url_cyrillic_extension', 'ext_hook' => 'admin_before_closing_head_tag_hook');
	...
	{
		$result = '';
		$result .= '<script type="text/javascript" src="' . FWURL . 'js/jquery_stringtoslug/jquery.stringToSlug_cyr.js"></script>
					<script>
