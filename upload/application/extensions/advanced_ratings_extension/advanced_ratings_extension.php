...
class Advanced_ratings_extension
{
	private $registry;
	private $prefix;
	private $data = array('ext_name' => 'Advanced Ratings Extension', 'ext_description' => 'Advanced 5 Star Rating Extension', 'ext_version' => '1.0', 'ext_order' => '1', 'ext_file_name' => 'advanced_ratings_extension', 'ext_hook' => 'before_blog_article_hook');
	...
	public function index()
	{
		...
		$result .= '	<div id="' . $parameter . '" class="rate_widget">
