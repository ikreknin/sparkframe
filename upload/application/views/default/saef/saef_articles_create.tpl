...
<input style="width: 200px" type='text' name='art_created' value='{art_created}' />
<br /><br />
...
{/if}
{if '{editor_type}'=='c'}
<textarea class="ckeditor" name='article' rows='16'>{article}</textarea>
{/if}
<br /><br />
...
{/if}
{if '{editor_type}'=='c'}
<textarea class="ckeditor" name='article_extended' rows='16'>{article_extended}</textarea>
{/if}
<br /><br />
