...
class Accessible_mega_menu_widget
{
	...
	{
		$result = '';
		$result .= '<link rel="stylesheet" href="' . FWURL . 'application/widgets/accessible_mega_menu_widget/css/megamenu.css">
<script src="' . FWURL . 'application/widgets/accessible_mega_menu_widget/js/jquery-accessibleMegaMenu.js"></script>
<script src="' . FWURL . 'application/widgets/accessible_mega_menu_widget/js/main.js"></script>
<div>
    <nav class="megamenu">
        <ol>
            <li>
