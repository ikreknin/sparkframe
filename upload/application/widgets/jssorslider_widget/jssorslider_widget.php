...
class jssorslider_widget
{
    ...
    <style> 
        ...
        .bricon
        {
            background: url(' . FWURL . 'application/widgets/jssorslider_widget/images/browser-icons.png);
        }
    </style>
    ...
    <script type="text/javascript" src="' . FWURL . 'application/widgets/jssorslider_widget/js/jssor.slider.mini.js"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; width: 980px;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(' . FWURL . 'application/widgets/jssorslider_widget/images/loading.gif) no-repeat center center;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px; height: 380px;
            overflow: hidden;">
            <div>
                <img u="image" src="' . FWURL . 'application/widgets/jssorslider_widget/images/home/01.jpg" />
            ...
            <div> 
                <img u="image" src="' . FWURL . 'application/widgets/jssorslider_widget/images/home/02.jpg" />
            ...
            <div> 
                <img u="image" src="' . FWURL . 'application/widgets/jssorslider_widget/images/home/03.jpg" />
            ...
            <div>
                <img u="image" src="' . FWURL . 'application/widgets/jssorslider_widget/images/home/04.jpg" />
                ...
                <img u="caption" t="T|IB" t2=B d=-900 src="' . FWURL . 'application/widgets/jssorslider_widget/images/home/moc-iphone.png" style="position:absolute;left:600px;top:230px;width:120px;height:80px;" />
                <img u="caption" t="RTTL|BR" d=-450 src="' . FWURL . 'application/widgets/jssorslider_widget/images/home/moc-ipad.png" style="position:absolute;left:750px;top:220px;width:77px;height:100px;" />
            </div>
            ...
            <style>
                .share-icon {
                    ...
                    background-image: url(' . FWURL . 'application/widgets/jssorslider_widget/images/share/share-icons.png);
                }
        ...
        <a class="share-icon share-email" target="_blank" href="mailto:?Subject=Jssor%20Slider&Body=Highly%20recommended%20JavaScript%20jQuery%20Image%20Slider/Slideshow/Carousel/Gallery/Banner%20html%20TOUCH%20SWIPE%20Responsive%20http://jssor.com" title="Share by Email"></a>
            ...
            <img u="any" class="qr_code" src="' . FWURL . 'application/widgets/jssorslider_widget/images/qr/jssor.com.png" style="position: absolute; width: 80px; height: 80px; bottom: 20px; right: 20px; opacity: .5; filter: alpha(opacity=50);" />
        ...
        <style>
            ...
            */
            ...
            {
                background: url(' . FWURL . 'application/widgets/jssorslider_widget/images/b03.png) no-repeat;
                overflow:hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora20l, .jssora20r, .jssora20ldn, .jssora20rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(' . FWURL . 'application/widgets/jssorslider_widget/images/a20.png) no-repeat;
                overflow:hidden;
            }
